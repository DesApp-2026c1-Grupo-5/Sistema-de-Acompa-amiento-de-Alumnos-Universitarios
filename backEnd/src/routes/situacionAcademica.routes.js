...
router.delete("/student/academic-situation/finals/:id", authMiddleware, validate(finalIdParamSchema, "params"), controller.eliminarFinal);
router.patch("/student/academic-situation/finals/:id", authMiddleware, validate(finalIdParamSchema, "params"), validate(actualizarFinalSchema), controller.actualizarFinal);
