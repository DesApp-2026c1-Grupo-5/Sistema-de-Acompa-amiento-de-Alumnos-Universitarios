...
const recommendationsData = [
  { id: 1, type: 'info', text: 'Podrías adelantar Base de Datos ya que cumplís con todas las correlatividades' },
  { id: 2, type: 'warning', text: 'La regularidad de Matemática II vence pronto. Te conviene rendir el final antes de cursar Redes' },
  { id: 3, type: 'info', text: 'Considerá distribuir mejor tu carga horaria: el próximo cuatrimestre está sobrecargado' }
];
